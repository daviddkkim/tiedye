...
import { Button, Dialog, Label, TextInput, DialogCloseButton, TextArea } from "..";
import {
                ...
                <Box css={{
                    ...
                    <DialogCloseButton asChild>
                        <Button css={{
                            ...
                            onClick={() => { onTodoWidgetAdd() }}><ListBulletIcon />{"To-do list"}</Button>
                    </DialogCloseButton>
                    <Button disabled
                        muted
                        css={{
                            ...
                            justifyContent: 'center',
                            alignItems: 'center'
                        }}><ChatBubbleIcon /> {"Chat (coming soon)"}</Button>
                </Box>
            )}
            {phase === "post" && (
                <>
